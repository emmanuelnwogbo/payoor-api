...
products.post('/product/inventory/create', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var productWithSameName, _req$body, itemname, description, price, category, stockQuantity, imageUrl, bestseller, productItem, savedProduct;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          productWithSameName = _context2.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 15:
          ...
          console.error('Internal Server Error:', _context4.t0);
          res.status(500).send({
            message: 'Internal Server Error',
